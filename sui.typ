...
#set document(
  ...
  description: "injecting custom section with arbitrary data into prebuilt executables",
)
...
Resource is added as section in a new segment, load commands are updated and offsets are adjusted. \_\_LINKEDIT is kept at the end of the file.

It is similar to linker's -sectcreate,\_\_FOO,\_\_foo,hello.txt option.
